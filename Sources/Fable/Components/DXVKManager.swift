...
/// A namespace, not an object: every member is static and nothing ever held an
/// instance. It was an `ObservableObject` that no view observed and no root
/// injected.
enum DXVKManager {
    ...
    static let routedDLLs = ["d3d9", "d3d10core", "d3d11", "d3d12", "d3d12core", "dxgi"]
    ...
    static let memoryDietConfigName = "fable-dxvk.conf"
    ...
    static func ensureMemoryDietConfig(at prefix: URL, vramMB: Int) throws -> URL {
